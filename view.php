                    ...
                    <div class="wrapper row">
                        <div class="preview col-md-6">
                            <div class="preview-pic tab-content">
                                <div class="tab-pane active" style="width: 400px;height: 400px" id="pic-2"><img src="http://hinhnendepnhat.net/wp-content/uploads/2016/09/hinh-nen-girl-dep.jpg" /></div>
                            </div>
                        </div>
                        <div class="details col-md-6">
                            ...
                            <div class="action">
                                ...
                                <button id="product" style="float: right;" class="add-to-cart btn-md btn-default" type="button">Mua ngay</button>
                            </div>
                        </div>
                    </div>
                </div>
