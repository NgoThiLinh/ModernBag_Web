...
if (isset($_POST["category"])) {
    ...
    echo"
            <div class='nav nav-pills nav-stacked'>
                <li class='active '>
                    <a>
                        <h4 class='sizeactive'>Danh mục</h4>
                    </a>
                </li>
            ";
...
if (isset($_POST["brand"])) {
    ...
    echo"
            <div class='nav nav-pills nav-stacked'>
                <li class='active '>
                    <a>
                        <h4 class='sizeactive'>Nhãn hiệu</h4>
                    </a>
                </li>
            ";
    if (mysqli_num_rows($run_query) > 0) {                                      //Loop
            ...
            <ul class='grid cs-style-4'>
                <li style='width: 250px; margin-left: -24px; margin-top: -25px;'>
                    <figure>
                        ...
                        <figcaption>
                            <h4 style='color:  greenyellow;' class='center'>$pro_title</h4>
                            <h3 class='center lightyellow' style='font-size: 15px;'>Giá: $pro_price VND</h3><br>
                            <h5 style='color:  greenyellow;' class='center'>Mô tả: $pro_des</h5>
                        </figcaption>
                    </figure>
                </li>
                <h4 class='center' style='margin-top: -13px;'>$pro_title</h4>
                <h3 class='center lightyellow' style='    margin-top: 0px; font-size: 15px;'>Giá: $pro_price VND</h3><br>
                <button 
                                pid='$pro_id' 
...
<div style='z-index: 1;' id='detail' class='overlay'>
        <div class='popup_changepassword'>
            ...
            <div class='content'>
                ...
                <label>Tên sản phẩm: <b style='color: #fe980f'>$pro_title</b></label><br>
                <label>Giá: <b style='color: #fe980f'>$pro_price VND</b></label><br>
                <label>Mô tả: <b style='color: #fe980f'>$pro_des</b></label><br>
            </div>
        </div>
    </div>
        ...
        if ($count > 0) {
            echo "
                    <div class='alert alert-warning'>
                        ...
                        <b>Sản phẩm đã tồn tại trong <a style='color: red' href='cart.php'>giỏ hàng</a> của bạn!</b>
                     </div>
                ";                                                                  //Not in video
        } else {
            ...
            if (mysqli_query($con, $sql)) {
                ...
                <div class='alert alert-success'>
                    ...
                    <b>Sản phẩm đã được thêm vào <a style='color: red' href='cart.php'>giỏ hàng</a> !</b>
                </div>
                    ";
            }
        }
        ...
        if ($count1 > 0) {
            echo "
                    <div class='alert alert-warning'>
                        ...
                        <b>Sản phẩm đã tồn tại trong giỏ hàng của bạn!</b>
                     </div>
                ";                                                                  //Not in video
        } else {
           ...
           <div class='alert alert-success'>
                ...
                <b>Bạn đang mua hàng ở chế độ khách!. Bạn có thể <b>đăng nhập</b> hoặc <a href='customer_registration.php' style='color: blue'>đăng kí</a> tài khoản mới.</b>
            </div>
...
<div class='row'>
    ...
    <div class='col-md-3 col-xs-3'>$pro_price VND</div>
</div>
";
                $no = $no + 1;
            } else {
        ...
        if (isset($_POST["cart_checkout"])) {
            ...
            echo "
                <div class='row'>
                    ...
                    <div class='col-md-4'>
                    <h4>Thành tiền: $total_amt VND</h4>
                </div>
                <div class='row'>
                    <div class='col-md-8'></div>
                    <div class='col-md-4'>
                        <h1 style=' margin-left: 43px;'>
                            <a href='#popup2' 
                            type='button'>
                                <img title='Thanh toán tại đây' src='images/pay.png' 
                                width='100px' 
                                height='60px'>
                            </a>
                        </h1>
                ...
                <div style='z-index: 9999;' id='popup2' class='overlay'>
                    <div class='pay_popup'>
                        ...
                        <div class='content'>
                            ...
                            <h5>Khách hàng:<b style='color: blue'> $namepay $lastname</b></h5>
                            <h5>Địa chỉ: <b style='color: blue'> $addresspay</b></h5>
                            <h5>Số điện thoại: <b style='color: blue'> $phonepay</b></h5>
                            <h5>Email: <b style='color: blue'> $emailpay</b></h5>
                            <hr>
            ...
            echo "
                    ...
                    <tr>
                        <td colspan='3'><b style='color: blue'>Tổng tiền</b></td>
                        <td><b style='color: blue'>$total_amt</b></td>
                    </tr>
                            </table>
                        </div>
                        <hr>  
                             <input  type='button' class='btn btn-primary1' id='buttonout' value='Xuất hóa đơn'>
                    </div>
                </div>";
        }                                              //Profile
    }
...
if (isset($_POST["removeFromCart"])) {
    ...
    <div class='alert alert-danger'>
        <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
        <b>Sản phẩm đã được xóa khỏi giỏ hàng của bạn!</b>
    </div>
    ";
    }
}
...
if (isset($_POST["updateProduct"])) {
    ...
    <div class='alert alert-success'>
        <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a>
        <b>Sản phẩm đã được cập nhật...Trở về <a style='color:red' href='index.php'>trang chủ</a> để tiếp tục mua hàng!</b>
    </div>
    ";
    }
}
        ...
        echo "
            ...
            <div class='row'>
                ...
                <div class='col-md-1' style='margin-left: -47px; margin-top: 5px;'>
                    <a href=''>
                        <img src='images/reload.png' title='Tải lại trang' style='width: 20px;'></a>
                </div>	
...
if (isset($_POST["outhistory"])) {
    $namepay = $_SESSION["name"];
    $querrypay = "SELECT *FROM user_info WHERE first_name = '$namepay';";    // Lịch sử giao dịch
    $rpay = mysqli_query($con, $querrypay);
    $rowpay = mysqli_fetch_array($rpay);
    ...
    $sqlquery = "INSERT INTO history VALUES('NULL','$namepay',$total_amt,'Đã thanh toán','$date_orderok');";
    ...
    <div class='alert alert-success'>
        ...
        <b>
            <a href='index.php'>
                <b style='color:red'>[Modern Bag]</b>
            </a> Thanh toán thành công. Hẹn gặp lại bạn!
        </b>
    </div><script>alert('[Modern Bag] Thanh toán thành công. Hẹn gặp lại bạn!')</script>
    ";
    }
...
if (isset($_POST["deleteallguest"])) {
    ...
    <div class='alert alert-success'>
        ...
        <b>
            <a href='index.php'>
                <b style='color:red'>[Modern Bag]</b>
            </a>Xóa thành công. Hệ thống tự động làm mới giỏ hàng sau <b>3s</b>...
        </b>
        <script type='text/javascript'>
            init_reload();
            function init_reload(){
