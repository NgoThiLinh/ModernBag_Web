                                            ...
                                            <div style="width:300px;">
                                                <div class="panel panel-primary">
                                                    ...
                                                    <div id="" class="panel-heading">
                                                        ...
                                                        <input type="email" class="form-control" onclick="focus(this)" placeholder="Email" id="email" required/>  <!-- required: Bắt người dùng nhập rồi mới bấm submit-->
                                                        ...
                                                        <input type="submit" class="btn btn-success" style="float:right;" id="login" value="Đăng nhập">
                                                    </div>
